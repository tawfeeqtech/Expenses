!function (e) {
    ...
    a.prototype.createAreaChart = function (e, a, t, r, i, n, o, s) {
        ...
        this.createAreaChart("morris-area-example", 0, 0, [{y: "2009", a: 10, b: 20}, {
            ...
            a: 75,
            b: 65
        }, {y: "2015", a: 90, b: 60}], "y", ["a", "b"], ["Series A", "Series B"], ["#3db9dc", "#039cfd"]);
...
var chart = new Chartist.Pie("#animating-donut", {series: [10, 20, 50, 20], labels: [1, 2, 3, 4]}, {
    donut: !0,
    showLabel: !1,
...
chart.on("draw", function (e) {
    if ("slice" === e.type) {
        ...
        0 !== e.index && (t["stroke-dashoffset"].begin = "anim" + (e.index - 1) + ".end"), e.element.attr({"stroke-dashoffset": -a + "px"}), e.element.animate(t, !1)
    }
...
new Chartist.Bar("#bi-polar-bar", data, options), new Chartist.Line("#chart-with-area", {
